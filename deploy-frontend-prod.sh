...
docker push gcr.io/${PROJECT_NAME_PRD}/${FRONTEND_DOCKER_IMAGE_NAME}

yes | gcloud container images add-tag gcr.io/${PROJECT_NAME_PRD}/${FRONTEND_DOCKER_IMAGE_NAME}:$TRAVIS_COMMIT gcr.io/${PROJECT_NAME_PRD}/${FRONTEND_DOCKER_IMAGE_NAME}:latest
